...
@Component({
    ...
    template: `
        ...
        <button #btn type="button" pButton label="Menu" icon="fa fa-bars" 
         class="ui-button-info" (click)="openMenu(menu, $event)"></button>
...
export class SideMenuComponent implements OnInit, OnDestroy {
    ...
    getLoggedInMenu(): MenuItem[] {
        return [
            {
                label: 'Edit Profile',
                icon: 'fa far fa-address-card', command: (event) => {
            ...
            {
                label: 'Logout',
                icon: 'fa fas fa-sign-out-alt', command: (event) => {
                    // Call the service
    ...
    getLoginButton(): MenuItem[] {
        return [
            {
                label: 'Login',
                icon: 'fa fas fa-sign-in-alt', command: (event) => { 
                    this.showLogIn();
                }
            }
        ];
