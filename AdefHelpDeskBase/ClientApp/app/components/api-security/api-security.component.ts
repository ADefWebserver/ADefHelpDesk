...
export class ApiSecurityComponent implements OnInit {
    ...
    GetSettings() {
        ...
        var strCurrentLocation = window.location.toString();
        var strRouterURL = this._router.url.toString();
        this.swaggerWebAddress = strCurrentLocation.replace(this._router.url,'/swagger');
    }
